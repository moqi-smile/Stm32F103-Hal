 ...
 */
#define DIO0                                        Gpio_ReadInput(RADIO_DIO0)
#define DIO1                                        Gpio_ReadInput(RADIO_DIO1)
#define DIO2                                        Gpio_ReadInput(RADIO_DIO2)
#define DIO3                                        Gpio_ReadInput(RADIO_DIO3)
#define DIO4                                        Gpio_ReadInput(RADIO_DIO4)
#define DIO5                                        Gpio_ReadInput(RADIO_DIO5)
